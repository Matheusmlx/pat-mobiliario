...
/**
 * QReservaEntity is a Querydsl query type for ReservaEntity
 */
@Generated("com.querydsl.codegen.EntitySerializer")
public class QReservaEntity extends EntityPathBase<ReservaEntity> {

    private static final long serialVersionUID = -1626095159L;

    public static final QReservaEntity reservaEntity = new QReservaEntity("reservaEntity");
    ...
    public final NumberPath<Long> quantidadeRestante = createNumber("quantidadeRestante", Long.class);
    ...
    public QReservaEntity(String variable) {
        super(ReservaEntity.class, forVariable(variable));
    }

    public QReservaEntity(Path<? extends ReservaEntity> path) {
        super(path.getType(), path.getMetadata());
    }

    public QReservaEntity(PathMetadata metadata) {
        super(ReservaEntity.class, metadata);
    }
