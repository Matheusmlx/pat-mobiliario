...
values
(NEXT VALUE FOR comum_siga.seq_pessoa_atributo, 'EMAIL', 'EMAIL', 'fornecedor1@azi.com.br', 1),
(NEXT VALUE FOR comum_siga.seq_pessoa_atributo, 'EMAIL', 'EMAIL', 'fornecedor2@azi.com.br', 2),
(NEXT VALUE FOR comum_siga.seq_pessoa_atributo, 'EMAIL', 'EMAIL', 'fornecedor3@azi.com.br', 3),

(NEXT VALUE FOR comum_siga.seq_pessoa_atributo, 'TELEFONE', 'TELEFONE_FIXO_COMERCIAL', '30270001', 1),
(NEXT VALUE FOR comum_siga.seq_pessoa_atributo, 'TELEFONE', 'TELEFONE_FIXO_COMERCIAL', '30215050', 2),
(NEXT VALUE FOR comum_siga.seq_pessoa_atributo, 'TELEFONE', 'TELEFONE_FIXO_COMERCIAL', '99186117', 3)
;
...
values
('fornecedor1', 'fornecedor1@azi.com.br', '57708514738', 'Fornecedor Google', 0, '33266655', 'ATIVO', 1, 30, 'EXTERNO'),
('fornecedor2', 'fornecedor2@azi.com.br', '90787358215', 'Fornecedor Nu Bank', 0, '99814242', 'ATIVO', 1, 30, 'EXTERNO'),
('fornecedor3', 'fornecedor3@azi.com.br', '93548959059', 'Fornecedor Jumbitos', 0, '33514332', 'ATIVO', 1, 30, 'EXTERNO')
;
...
values
    ...
    ('DEFAULT', (select pe_id from comum_siga.tb_pessoa where pe_cpf_cnpj = '06990590000123'), (select us_id from comum.tb_usuario where us_email = 'fornecedor1')),
    ('DEFAULT', (select pe_id from comum_siga.tb_pessoa where pe_cpf_cnpj = '18236120000158'), (select us_id from comum.tb_usuario where us_email = 'fornecedor1')),
    ('DEFAULT', (select pe_id from comum_siga.tb_pessoa where pe_cpf_cnpj = '01382349000106'), (select us_id from comum.tb_usuario where us_email = 'fornecedor1')),

    ('DEFAULT', (select pe_id from comum_siga.tb_pessoa where pe_cpf_cnpj = '18236120000158'), (select us_id from comum.tb_usuario where us_email = 'fornecedor2')),
    ('DEFAULT', (select pe_id from comum_siga.tb_pessoa where pe_cpf_cnpj = '01382349000106'), (select us_id from comum.tb_usuario where us_email = 'fornecedor3'))
;
...
values
(
    NEXT VALUE FOR efcaz.seq_representante,
