...
@Rollback
@Sql({"/datasets/movimentacao/interna/edicao/editar-movimentacao-definitiva.sql"})
@Transactional
public class EditarMovimentacaoEntreSetoresControllerTest {

    @Autowired
    private MockMvc mockMvc;

    @Test
    public void deveEditarMovimentacaoDefinitiva() throws Exception {
        ...
        mockMvc.perform(
            put("/movimentacoes/internas/definitiva/1")
