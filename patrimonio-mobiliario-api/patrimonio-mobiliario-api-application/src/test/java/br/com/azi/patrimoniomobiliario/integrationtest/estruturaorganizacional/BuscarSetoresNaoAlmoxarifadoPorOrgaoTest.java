...
public class BuscarSetoresNaoAlmoxarifadoPorOrgaoTest {
    ...
    public void deveBuscarUnidadeOrganizacional() throws Exception{
        ...
        mockMvc.perform(
            get("/unidades-organizacionais/2/setores-nao-almoxarifado")
    ...
    private void createMockRequisicaoSetup() {
        ...
        wireMockRule.stubFor(WireMock.get(urlEqualTo("/setup/hal/unidadeOrganizacionalDominio/2/buscarSetoresFiltrandoPorAlmoxarifado/2?funcao=Mobiliario.Consulta&almoxarifado=false"))
