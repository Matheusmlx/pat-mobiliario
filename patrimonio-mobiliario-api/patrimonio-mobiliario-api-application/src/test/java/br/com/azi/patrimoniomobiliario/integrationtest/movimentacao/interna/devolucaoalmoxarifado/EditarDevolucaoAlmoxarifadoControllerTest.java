...
@Rollback
@Sql({"/datasets/movimentacao/interna/edicao/editar-devolucao-almoxarifado.sql"})
@Transactional
public class EditarDevolucaoAlmoxarifadoControllerTest {

    @Autowired
    private MockMvc mockMvc;

    @Test
    public void deveEditarDevolucaoAlmoxarifado() throws Exception {
        ...
        mockMvc.perform(
            put("/movimentacoes/internas/devolucao-almoxarifado/1")
