...
public class BuscarFundosTest {
    ...
    public void deveBuscarUnidadeOrganizacional() throws Exception{
        ...
        mockMvc.perform(
            get("/unidades-organizacionais/89/fundos")
    ...
    private void createMockRequisicaoSetup() {
        ...
        wireMockRule.stubFor(WireMock.get(urlEqualTo("/setup/hal/unidadeOrganizacionalDominio/2/buscarFundosPorEstruturaAdministradoraEFuncao?unidadeOrganizacionalId=89&funcao=Mobiliario.Consulta"))
