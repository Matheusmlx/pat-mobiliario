package br.com.azi.patrimoniomobiliario.integrationtest.movimentacao.interna.distribuicao;
...
@Sql({"/datasets/movimentacao/interna/edicao/editar-distribuicao.sql"})
@Transactional
@Rollback
public class EditarDistribuicaoControllerTest {

    @Autowired
    private MockMvc mockMvc;

    @Test
    public void deveEditarUmaDistribuicaoExistente() throws Exception {
        final EditarDistribuicaoInputData inputData = EditarDistribuicaoInputData
            .builder()
            .orgao(8772L)
            .setorOrigem(1164L)
            .setorDestino(6056L)
        ...
        mockMvc.perform(
            put("/movimentacoes/internas/distribuicao/1")
