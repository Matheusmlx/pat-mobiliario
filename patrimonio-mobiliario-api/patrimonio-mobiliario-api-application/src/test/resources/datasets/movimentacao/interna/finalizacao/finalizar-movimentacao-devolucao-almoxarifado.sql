...
(8772, 'Defensoria Pública Geral do Estado', 'DPGE', 'ATIVO', 'INFORMAL', null, '0002.0001', true),
(1164, 'Assessoria de Relações Institucionais', 'ARI', 'ATIVO', 'FORMAL', null,'0002.0002.0002.0006.0002.0001', false),
(1165, 'Assessoria de Relações Extrangeiras e Internacionais', 'AREI', 'ATIVO', 'FORMAL', null,'0002.0002.0002.0006.0002.0002', true);
...
(2, '0000002', 1000, 'ATIVO', 1, 8772, 1164, 100, 100),
(3, '0000003', 1000, 'ATIVO', 1, 8772, 1164, 100, 100),
...
(3, '00001', 'DEVOLUCAO_ALMOXARIFADO', 'EM_ELABORACAO', 8772, 1164, 8772, 1165);
