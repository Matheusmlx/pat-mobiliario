...
values (1, 10, '0001', 'descricao', 'EM_ELABORACAO', 1, 100, 1);
...
(1, '00001', 'DISTRIBUICAO', 'EM_ELABORACAO', 8772, 1164, 8772, 1165);

insert into pat_mobiliario.tb_movimentacao_item (mo_id, pa_id) values
(1, 3),
(1, 5);

-- MOVIMENTACAO COM UM ITEM
insert into pat_mobiliario.tb_movimentacao (mo_id, mo_codigo, mo_tipo, mo_situacao, uo_id_orgao_origem, uo_id_setor_origem, uo_id_orgao_destino, uo_id_setor_destino) values
(2, '00002', 'DISTRIBUICAO', 'EM_ELABORACAO', 8772, 1164, 8772, 1165);
