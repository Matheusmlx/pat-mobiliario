...
-- TB_PATRIMONIO
insert into pat_mobiliario.tb_patrimonio (pa_id, pa_numero, pa_valor_aquisicao, pa_valor_entrada, pa_valor_liquido, pa_situacao, ini_id, uo_id_orgao, uo_id_setor,  cc_id_atual, cc_id_classificacao) values
(1, '0000001', 1000, 1000, 1000, 'ATIVO', 1, 8772, 1165, 100, 100),
(2, '0000002', 1000, 1000, 1000, 'ATIVO', 1, 8772, 1165, 100, 100),
(3, '0000003', 1000, 1000, 1000, 'ATIVO', 1, 8772, 1165, 100, 100),
(4, '0000004', 1000, 1000, 1000, 'ATIVO', 1, 8772, 1165, 100, 100),
(5, '0000005', 1000, 1000, 1000, 'ATIVO', 1, 8772, 1165, 100, 100);
...
(1, '00001', 'TEMPORARIA', 'AGUARDANDO_DEVOLUCAO', 8772, 1164, 8772, 1165);
...
-- TB_MOVIMENTACAO
insert into pat_mobiliario.tb_movimentacao (mo_id, mo_codigo, mo_tipo, mo_situacao, uo_id_orgao_origem, uo_id_setor_origem, uo_id_orgao_destino, uo_id_setor_destino) values
(2, '00001', 'TEMPORARIA', 'AGUARDANDO_DEVOLUCAO', 8772, 1164, 8772, 1165);
